...
day-to-day since 2019 (`r lubridate::year(Sys.Date()) - 2019`+ years),
mostly building R packages, data pipelines, and validated reporting for
clinical research. Reproducibility, code review, and audit-readiness
are the baseline for everything I ship.
